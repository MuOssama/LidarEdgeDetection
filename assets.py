...
def filter_readings(readings, car_width_half=0.75):
    ...
    for reading in readings:
        ...
        if i>573: #this to only read the forward readings only
...
def edgeDetecting(readings):
    readings = arrange_list(readings,"4 1 2 3") #in RP lidar A1 "4 1 2 3"
    readings = filter_readings(readings, car_width_half=0.75) #this is half of width of VW beetle
